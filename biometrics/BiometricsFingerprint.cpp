 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.1-service.asus_X00T"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.1-service.asus_X00T"
...
init_err:
    property_set("persist.vendor.runin.fp", "unkown");
    return nullptr;
}
